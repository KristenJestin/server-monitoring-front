            ...
            switch (type) {
                case 'success':
                    return {
                        ...
                        textColor:
                            'text-green-500 transition duration-500 ease-in-out dark:text-green-400',
                ...
                case 'warning':
                    return {
                        ...
                        textColor:
                            'text-yellow-400 transition duration-500 ease-in-out dark:text-yellow-300',
                ...
                case 'error':
                    return {
                        ...
                        textColor:
                            'text-red-500 transition duration-500 ease-in-out dark:text-red-400',
                ...
                default:
                    return {
                        ...
                        textColor:
                            'text-blue-500 transition duration-500 ease-in-out dark:text-blue-400',
                        path: 'M20 3.33331C10.8 3.33331 3.33337 10.8 3.33337 20C3.33337 29.2 10.8 36.6666 20 36.6666C29.2 36.6666 36.6667 29.2 36.6667 20C36.6667 10.8 29.2 3.33331 20 3.33331ZM21.6667 28.3333H18.3334V25H21.6667V28.3333ZM21.6667 21.6666H18.3334V11.6666H21.6667V21.6666Z',
                    }
            }
        }
